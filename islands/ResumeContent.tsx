      ...
      <div className="max-w-4xl mx-auto bg-[#E7DECA] text-[#32564f] p-8 rounded-lg border border-[#32564f]">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-8">
          <p className="text-left text-[#32564f]/80 mb-4 md:mb-0">
            <a className="underline" href="mailto:joel@cuthriell.com">
              joel@cuthriell.com
            </a>{" "}
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-3 pb-2 border-b border-[#32564f]/20">
            Skills
          </h2>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-5 grid grid-cols-1 md:grid-cols-2 gap-1">
            <li>
              <a
                href="https://www.credly.com/earner/earned/share/087284e9-fec9-4edb-9e51-c590b4529d76"
                target="_blank"
                rel="noopener noreferrer"
        ...
        {/* Experience */}
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4 pb-2 border-b border-[#32564f]/20">
            Experience
          </h2>
          ...
          <div className="mb-6">
            ...
            <ul className="list-disc pl-5">
              <li>
                Design and implement user interfaces for employee and
                member-facing applications
              </li>
              <li>
                Create vector and CSS animations for enhanced user experience
              </li>
              <li>
                Develop complex information displays using Angular and Bootstrap
              </li>
          ...
          <div className="mb-6">
            ...
            <ul className="list-disc pl-5">
              <li>
                Heavy focus on user research, troubleshooting, and building
                systems for employee use
              </li>
              <li>
                Develop brochure sites and frontend interfaces using React
                Native, React, and Gatsby
              </li>
              <li>
                Advise on and implement project management practices, including
                Kanban methodologies
              </li>
              <li>
                Manage IT infrastructure across multiple business locations
              </li>
            </ul>
          </div>
          ...
          <div className="mb-6">
            ...
            <ul className="list-disc pl-5">
              <li>
                Design and refine projects using Foundation, React, and Angular
              </li>
              <li>
                Implement API integrations for CRUD operations, including JWT
                authentication
              </li>
              <li>
                Reviewed strategy and interface direction with owners users
              </li>
              <li>
                Collaborate with backend developers on C# and .NET systems
              </li>
          ...
          <div className="mb-6">
            ...
            <ul className="list-disc pl-5">
              <li>
                Lead development of responsive websites, from brochure sites to
                full e-commerce platforms
              </li>
              <li>
                Design reviews with creative staff and technical instruction
              </li>
              <li>
                Specialize in custom design and animation for enhanced user
                engagement
              </li>
              <li>
                Manage IT infrastructure, including LAMP stack servers, local
        ...
        <section>
          ...
          <ul className="list-disc pl-5">
            ...
            <li>
              HIPAA-compliant secure file scanning workflow for a surgical
              equipment consultant
            </li>
            <li>
              Motion graphics for CommunityCare HMO:{" "}
              <a
                href="https://www.youtube.com/watch?v=n2ru5WyMzLk"
                target="_blank"
                rel="noopener noreferrer"
                className="text-[#32564f] hover:underline"
              >
            ...
            <li>
              Homepage content modernization for{" "}
              <a
                href="https://ccok.com/"
                target="_blank"
                rel="noopener noreferrer"
            ...
            <li>
              Cryptocurrency project contributions: Developed marketing
              strategies, designed infographics, and organized community
              initiatives
            </li>
          </ul>
        </section>
