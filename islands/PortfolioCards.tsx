...
export default function PortfolioCards() {
    ...
    const prevImage = () => {
        setCurrentImageIndex((prevIndex) => (prevIndex - 1 + 6) % 6);
    };
                ...
                {initialCards.map((card) => (
                    <div key={card.id} 
                         className="group relative overflow-hidden transition-all duration-500 ease-in-out 
                                  hover:transform hover:scale-[1.02] hover:shadow-xl card-hover">
                        <div className="border border-[#232323] rounded-lg p-6 
                                      bg-gradient-to-br from-[#1a1a1a] via-[#232323] to-[#1a1a1a]
                                      shadow-lg backdrop-blur-sm gradient-animate gradient-border
                                      noise-texture">
                            <div className="relative z-10 card-content">
                                ...
                                <p className="text-[#E7DECA] text-sm leading-relaxed opacity-90 
                                    ...
                                    <div className="relative h-48 overflow-hidden">
                                        {card.images.map((image, index) => (
                                            <img
                                                key={index}
                                                src={image}
                                                alt={`${card.title} illustration ${index + 1}`}
