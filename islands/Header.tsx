...
export default function Header() {
  ...
  const [_isImageHovered, setIsImageHovered] = useState(false);
  ...
  const handleScroll = useCallback(() => {
    if (typeof window !== "undefined") {
      setIsScrolled((globalThis.scrollY || 0) > 20); // Reduced threshold for earlier collapse
    }
  }, [initialHeaderHeight]);
    ...
    <>
      <header
        ...
        className={`
          ...
          isScrolled
            ? "header-blur py-1"
            : "bg-gradient-to-r from-[#1a1a1a] via-[#232323] to-[#1a1a1a] py-4 sm:py-6"
        }
